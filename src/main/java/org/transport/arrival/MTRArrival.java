...
import org.transport.consolidation.MTRConsolidation;
...
public final class MTRArrival extends ArrivalBase {
	...
	public MTRArrival(WebClientHelperService webClientHelperService, MTRConsolidation mtrConsolidation) {
		super(Provider.MTR);
		this.webClientHelperService = webClientHelperService;
		this.mtrConsolidation = mtrConsolidation;
	}
